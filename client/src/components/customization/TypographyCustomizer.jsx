...
export const TypographyCustomizer = () => {
  ...
  const OptionSelector = ({ title, description, options, currentValue, onChange, renderPreview }) => (
    ...
    <div className="space-y-8">
      ...
      <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
        ...
        <ul className="text-sm text-indigo-700 space-y-1">
          <li>• <strong>Small font:</strong> Best for detailed CVs with lots of experience</li>
          <li>• <strong>Large font:</strong> Good for senior positions or accessibility needs</li>
          <li>• <strong>Compact spacing:</strong> Fits more content on single page</li>
          <li>• <strong>Spacious spacing:</strong> More readable, professional appearance</li>
          <li>• <strong>Bold headings:</strong> Modern, ATS-friendly choice</li>
        </ul>
      </div>
    </div>
  );
